...
urlpatterns = [
    ...
    path("raise_patient_radiology_service/<encounter_id>/", raise_patient_radiology_service_view, name="raise_patient_radiology_service"),
    ...
    path("radio_request_detail/<enc_id>", radiology_request_detail_view, name="radio_request_detail"),
